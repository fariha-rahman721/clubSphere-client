        ...
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-content">
                ...
                <nav className="navbar w-full bg-base-300">
                    ...
                    <div className="px-4 text-orange-500 font-bold">ClubSphere Dashboard</div>
                </nav>
                {/* Page content here */}
                <Outlet></Outlet>
            ...
            <div className="drawer-side is-drawer-close:overflow-visible">
                ...
                <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                    ...
                    <ul className="menu w-full grow">
                        {/* List item */}
                        <li>
                            <Link to='/' className="is-drawer-close:tooltip is-drawer-close:tooltip-right text-orange-600 font-semibold flex items-center gap-2" data-tip="Homepage">
                                {/* Home icon */}
